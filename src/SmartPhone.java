...
/*
 * Console class contains class variables
 * name,price,image,retailer,condition,discount and Accessories Hashmap.
 * 
 * Console class constructor with Arguments
...
public class SmartPhone extends HttpServlet {
	...
	public SmartPhone(String id, String name, double price, String image, String retailer, String condition,
			double discount) {
		this.id = id;
		this.name = name;
		this.price = price;
